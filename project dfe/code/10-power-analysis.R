...
sample = 100 # Anzahl N pro Sampling-Stufe
design <-
...
#  c(0.2,0.5,2,4,1,1) 
fix      <- c(0.1,0.6,0.5,0.9,-0.2,-0.5) # specify fixed-effects: Intercept, samplingn, typet2, typet3, sampling:typet2, samplingtypet3
sd_Subj  <- c(0.37,0.34,0.30) # specify subject random effects (standard deviation) 
...
summary(fit)
 ...
 nsubj <- seq(60,80,10) # we vary the number of subjects from 10 to 100 in steps of 1
